...
namespace Hazel {
	...
	Application::Application() 
		...
		m_SquareVertexBuffer.reset(VertexBuffer::Create(vertices2, sizeof(vertices2)));
		...
		m_SquareIndexBuffer.reset(IndexBuffer::Create(indices2, sizeof(vertices2) / sizeof(uint32_t)));
